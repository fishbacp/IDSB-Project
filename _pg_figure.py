...
class VLine(InfiniteLine):
    ...
    def __init__(self, mne, pos, bounds):
        pen = mne.mkPen('g',width=4)
        super().__init__(pos, pen=pen, hoverPen='g',
...
class Crosshair(InfiniteLine):
    ...
    def __init__(self, mne):
        super().__init__(angle=90, movable=False, pen='r')
        self.mne = mne
        self.y = 1
...
##    ANNOTATIONS SECTIONS ############ Comment out next five lines to remove annotation button
...
##            },
    ...
    def _xrange_changed(self, _, xrange):
        ...
        #########################################################
        #### START AND END TIMES OF WINDOW ARE STORED IN VALUES BELOW;
